...
const Waitlist = () => {
  ...
  return (
      <><div className="container mx-auto min-h-screen relative" >
         ...
         <div className="intro ml-16 ">
              ...
              <h1 className='text-5xl font-bold font-sans'>Introducing Wiauat App: <br />Revolutionizing Tracking, Security <br />and Locating</h1>
                  ...
                  <span class=" inline-flex sm:ml-10 sm:mt-6 justify-center sm:justify-start">
      <a class="transition duration-300 ease-in-out hover:scale-125 text-blue-700">
        <svg fill="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-5 h-5" viewBox="0 0 24 24">
          <path d="M18 2h-3a5 5 0 00-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 011-1h3z"></path>
        </svg>
      </a>
      <a class="ml-3 text-black cursor-pointer transition duration-300 ease-in-out hover:scale-125" href=' https://x.com/wiauatapp?t=Mxuc9WawJFClLVu5-sV9OA&s=09'>
        <svg fill="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-5 h-5" viewBox="0 0 24 24">
          <path d="M23 3a10.9 10.9 0 01-3.14 1.53 4.48 4.48 0 00-7.86 3v1A10.66 10.66 0 013 4s-4 9 5 13a11.64 11.64 0 01-7 2c9 5 20 0 20-11.5a4.5 4.5 0 00-.08-.83A7.72 7.72 0 0023 3z"></path>
        </svg>
      </a>
      <a class="ml-3 transition duration-300 ease-in-out hover:scale-125 bg-gradient-to-t from-purple-800 via-red-600 to-yellow-400  inline-block">
        <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-5 h-5" viewBox="0 0 24 24">
          <rect width="20" height="20" x="2" y="2" rx="5" ry="5"></rect>
          <path d="M16 11.37A4 4 0 1112.63 8 4 4 0 0116 11.37zm1.5-4.87h.01"></path>
        </svg>
      </a>
      <a class="ml-3 transition duration-300 ease-in-out hover:scale-125 text-blue-600">
        <svg fill="currentColor" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="0" class="w-5 h-5" viewBox="0 0 24 24">
          ...
          <div className="mt-16 relative  overflow-hidden bg-cover bg-no-repeat ">
              ...
              <h1 className='font-sans font-bold text-7xl ml-16 mt-10 p-16 text-left leading-normal'>This Application <br />is Currently <br /> Under Development</h1>
              <div className=" mt-10 ml-16">
                      <a href="https://chat.whatsapp.com/GMReW0NArzf2LtpStuoFhq" 
                          className='ml-16 bg-purple-900 hover:bg-purple-700 transition-all  text-white rounded-full px-20 py-2 font-bold font-sans'>join our community</a>
                  </div>
              </div>
          </div>
  ...
  <div className="container px-5 py-8 mx-auto flex items-center sm:flex-row flex-col">
    ...
    <img src="/Wiauat disp copy.png"
                  className='w-1/5' alt="" />
      <span className="ml-3 text-xl font-extrabold ">Wiauat App</span>
    </a>
    <p className="text-sm text-gray-500 sm:ml-4 sm:pl-4 sm:border-l-2 sm:border-gray-200 sm:py-2 sm:mt-0 mt-4">© 2025 wiauat —
      <a href="https://x.com/wiauatapp?t=Mxuc9WawJFClLVu5-sV9OA&s=09" class="text-gray-600 ml-1" rel="noopener noreferrer" target="_blank">@wiauatapp</a>
    </p>
